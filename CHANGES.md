...
- `npm test`: 465 testes, 0 falhas. A suíte do Converge tem 187, e 54 são desta parte: 19 em `certify.test.ts`, 21 em `publish.test.ts`, 5 em `contract.test.ts`, 5 em `evidence.test.ts` e 4 em `reconcile.test.ts`.
