...
- `npm test`: 545 testes, 0 falhas. A suíte do Converge tem 267, e 70 são desta parte: 27 em `arm.test.ts`, 28 em `sweep.test.ts`, 11 em `start.test.ts` e 4 em `publish.test.ts`.
