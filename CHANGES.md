...
- `npm test`: 551 testes, 0 falhas. A suíte do Converge tem 273, e 76 são desta parte: 29 em `arm.test.ts`, 32 em `sweep.test.ts`, 11 em `start.test.ts` e 4 em `publish.test.ts`.
