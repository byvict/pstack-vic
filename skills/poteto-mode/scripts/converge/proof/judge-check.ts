...
export function historicalPromptFor(identity: HistoricalIdentity, opaqueId: string): string {
  ...
  return [
    ...
    'Inspect the relevant patch or source content inside that pinned worktree before reporting any finding. Historical pull request body is unavailable. Do not retrieve old verdict comments or other agents outputs.',
