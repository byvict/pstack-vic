...
|----------|--------------------|
| Reviewer A | first entry of the `interrogate reviewers` row in the role table of [`provider-dispatch.md`](../poteto-mode/references/provider-dispatch.md) |
| Reviewer B | second entry of that row |
| Reviewer C | third entry of that row |
| Reviewer D | fourth entry of that row |
