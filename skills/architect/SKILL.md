...
Use your configured `architect runners` role, one runner per entry (default: its row in the role table of [`provider-dispatch.md`](../poteto-mode/references/provider-dispatch.md)).
