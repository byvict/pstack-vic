...
Linhas a acrescentar quando algo for copiado (fases 2, 4, 5, 7 do plano). Nada abaixo está copiado ainda, exceto o que já subiu para a tabela acima:

| Componente previsto | Upstream | Copyright | Licença | Arquivo de licença |
| --- | --- | --- | --- | --- |
| Runner externo (`skills/poteto-mode/scripts/runner/`), `codex-tools.md`, hook SessionStart, manifests Claude/Codex, scripts de sync, `setup-pstack`, substituições Cursor→Claude/Codex | [ericlitman/open-pstack @ de67e6b](https://github.com/ericlitman/open-pstack/tree/de67e6b40511814171e5e4c8ad7af3b79f07c9ee) (1.4.1) | (c) 2026 Lauren Tan (port: Eric Litman) | MIT | [LICENSE-open-pstack](LICENSE-open-pstack) (já copiado na fase 1) |
